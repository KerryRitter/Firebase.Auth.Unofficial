namespace Firebase.Auth.Unofficial
{
    ...
    public interface IFirebaseAuthProvider
    {
        ...
        /// <summary>
        /// Get the account info for the given idToken
        /// </summary>
        /// <param name="idToken">The Firebase Token or idToken</param>
        /// <returns>The account info</returns>
        Task<FirebaseAccountInfoResponse> GetAccountInfoAsync(string idToken);
