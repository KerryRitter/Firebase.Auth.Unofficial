...
namespace Firebase.Auth.Unofficial
{
    ...
    public class FirebaseInvalidTokenException : Exception
    {
        /// <summary>
        /// Default constructor
        /// </summary>

        public FirebaseInvalidTokenException() : base()
        {
        }
        ...
        public FirebaseInvalidTokenException(String message) : base(message)
        {
        }
        ...
        public FirebaseInvalidTokenException(String message, Exception innerException) : base(message, innerException)
        {
        }
    }
